    ...
    <>
      <div className=" flex flex-col justify-center h-screen mx-5">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input id="input-email" type="email" ref={emailRef} className='border-lgrey border-[1px] bg-transparent min-h-[48px] px-2'/>
          ...
          <div className='flex flex-row border-lgrey border-[1px]'>
            <input id="input-password" type={isPasswordVisible ? 'text' :'password'} ref={passwordRef} className='border-lgrey bg-transparent px-2'/>
